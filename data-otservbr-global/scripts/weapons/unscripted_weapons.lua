...
clubCombat:setFormula(COMBAT_FORMULA_SKILL, 0, 0, 0.7, 0)
...
swordCombat:setFormula(COMBAT_FORMULA_SKILL, 0, 0, 1.1, 0)
...
wandCombats.energy:setParameter(COMBAT_PARAM_CHAIN_EFFECT, CONST_ME_PINK_ENERGY_SPARK)
wandCombats.ice:setParameter(COMBAT_PARAM_CHAIN_EFFECT, CONST_ME_BLUE_ENERGY_SPARK)
