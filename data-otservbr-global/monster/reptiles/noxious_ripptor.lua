...
monster.attacks = {
	...
	{name ="combat", interval = 2500, chance = 40, type = COMBAT_EARTHDAMAGE, minDamage = -900, maxDamage = -1600, range = 1, radius = 1, shootEffect = CONST_ANI_POISON, effect = CONST_ME_POISONAREA, target = true},
