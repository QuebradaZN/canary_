...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -200, maxDamage = -400, range = ?, effect = <>, target = ?}, --Throws Hunting Spear
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -150, maxDamage = -300, range = ?, effect = <>, target = ?}, --Throws Boulder
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_HOLYDAMAGE, minDamage = -400, maxDamage = -700, range = ?, effect = <>, target = ?}, --Holy Beam
--}
monster.attacks = {
