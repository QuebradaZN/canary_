...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -270, range = ?, effect = <>, target = ?}, --Axe Throw
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -?, range = ?, effect = <>, target = ?}, --Boulder Throw
--	{name ="healing", interval = 2000, chance = 20, minDamage = 115, maxDamage = 195},
--}
monster.attacks = {
