...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -375+, maxDamage = -375+, range = ?, effect = <>, target = ?}, --Axe Throw
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -215+, maxDamage = -215+, range = ?, effect = <>, target = ?}, --Throws [[Spear]]
--}
monster.attacks = {
