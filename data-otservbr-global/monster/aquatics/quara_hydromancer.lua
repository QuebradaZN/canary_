...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ICEDAMAGE, minDamage = -100, maxDamage = -180, range = ?, effect = <>, target = ?}, --Cold Bubble Beam
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ICEDAMAGE, minDamage = -90, maxDamage = -150, range = ?, effect = <>, target = ?}, --Cold Bubble Berserk
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -170, maxDamage = -240, range = ?, effect = <>, target = ?}, --Green Life Drain Beam
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -170, range = ?, effect = <>, target = ?}, --Distance Life Drain
--}
monster.attacks = {
