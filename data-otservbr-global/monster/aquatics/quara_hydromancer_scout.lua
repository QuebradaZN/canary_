...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ICEDAMAGE, minDamage = -130, maxDamage = -165, range = ?, effect = <>, target = ?}, --Ice Berserk
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ICEDAMAGE, minDamage = -0, maxDamage = -210+, range = ?, effect = <>, target = ?}, --Cold Green Beam
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -125, maxDamage = -250, range = ?, effect = <>, target = ?}, --Life Drain Bubble Beam
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -45, maxDamage = -170, range = ?, effect = <>, target = ?}, --Distance Life Drain
