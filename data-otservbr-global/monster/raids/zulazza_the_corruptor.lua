...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -250, maxDamage = -500, range = ?, effect = <>, target = ?}, --[[Poison Bomb]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -100, maxDamage = -900, range = ?, effect = <>, target = ?}, --Cursing Beam
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_MANADRAIN, minDamage = -50, maxDamage = -250, range = ?, effect = <>, target = ?}, --Mana Drain Bomb
...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -poisons from 20 up to 40hp/turn, maxDamage = -poisons from 20 up to 40hp/turn, range = ?, effect = <>, target = ?}, --Poisoning Bomb
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -250, range = ?, effect = <>, target = ?}, --Groundshaker Bomb
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -225, maxDamage = -270, range = ?, effect = <>, target = ?}, --Frequent [[Self-Healing]]
--}
monster.attacks = {
