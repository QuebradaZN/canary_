...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -65, maxDamage = -180+, range = ?, effect = <>, target = ?}, --Divine Missile
--	{name ="healing", interval = 2000, chance = 20, minDamage = 0, maxDamage = 0},
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -20, maxDamage = -45+, range = ?, effect = <>, target = ?}, --Mana Drain
--}
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -50},
