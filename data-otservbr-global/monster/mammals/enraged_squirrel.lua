...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ENERGYDAMAGE, minDamage = -0, maxDamage = -11?, range = ?, effect = <>, target = ?}, --weak distance attack that looks like energy and stars
--}
monster.attacks = {
