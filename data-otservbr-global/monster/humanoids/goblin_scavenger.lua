...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -30, range = ?, effect = <>, target = ?}, --[[Distance Fighting|Spears]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_LIFEDRAIN, minDamage = -22, maxDamage = -30, range = ?, effect = <>, target = ?}, --Distance Life Drain
--	{name ="healing", interval = 2000, chance = 20, minDamage = 10, maxDamage = 16},
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_DEATHDAMAGE, minDamage = -1, maxDamage = -30, range = ?, effect = <>, target = ?}, --[[Death Strike]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ENERGYDAMAGE, minDamage = -0, maxDamage = -0, range = ?, effect = <>, target = ?}, --[[Energy Strike]] on himself
--}
monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -15 },
