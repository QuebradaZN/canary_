...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ENERGYDAMAGE, minDamage = -80, maxDamage = -160?, range = ?, effect = <>, target = ?}, --Burst Arrow
...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ENERGYDAMAGE, minDamage = -70, maxDamage = -120?, range = ?, effect = <>, target = ?}, --Chain attack
--}
monster.attacks = {
