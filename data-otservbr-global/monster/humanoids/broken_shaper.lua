...
--	{name ="healing", interval = 2000, chance = 20, minDamage = 0, maxDamage = 327+},
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -56+, range = ?, effect = <>, target = ?}, --[[Music Notes Wave]]
--}
monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -200 },
