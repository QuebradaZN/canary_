...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ICEDAMAGE, minDamage = -16, maxDamage = -32, range = ?, effect = <>, target = ?}, --[[Ice Missile]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ICEDAMAGE, minDamage = -9, maxDamage = -20, range = ?, effect = <>, target = ?}, --[[Ice Wave]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -8 damage; [[Freezing|Freezes]] you, maxDamage = -8 damage; [[Freezing|Freezes]] you, range = ?, effect = <>, target = ?}, --[[Berserk|Ice Berserk]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -for some seconds, maxDamage = -for some seconds, range = ?, effect = <>, target = ?}, --[[Invisibility]]
--}
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -22},
