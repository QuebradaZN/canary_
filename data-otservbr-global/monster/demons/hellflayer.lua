...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -850, maxDamage = -1250, range = ?, effect = <>, target = ?}, --Death Beam
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -450, maxDamage = -650, range = ?, effect = <>, target = ?}, --Shoots [[Flaming Arrow]]s
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -400, maxDamage = -550, range = ?, effect = <>, target = ?}, --Throws [[Throwing Star|stars]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -300, maxDamage = -500, range = ?, effect = <>, target = ?}, --Shoots [[Burst Arrow]]s
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -400, maxDamage = -500, range = ?, effect = <>, target = ?}, --Physical Bomb
--}
monster.attacks = {
