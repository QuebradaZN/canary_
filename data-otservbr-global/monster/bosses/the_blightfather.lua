...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -damage raises up to ?, maxDamage = -damage raises up to ?, range = ?, effect = <>, target = ?}, --makes you [[Cursed]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -0, range = ?, effect = <>, target = ?}, --[[Poison Bomb]] around itself
--}
monster.attacks = {
