...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ICEDAMAGE, minDamage = -750+, maxDamage = -750+, range = ?, effect = <>, target = ?}, --Ice Beam
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -7485, maxDamage = -7515, range = ?, effect = <>, target = ?}, --strong [[Self Healing]] once when on red hp
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -435, maxDamage = -465, range = ?, effect = <>, target = ?}, --Frequent [[Self Healing]]
--}
monster.attacks = {
