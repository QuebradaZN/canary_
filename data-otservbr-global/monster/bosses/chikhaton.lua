...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -500+, range = ?, effect = <>, target = ?}, --Throws [[Stone (Medium)|boulders]]
--	{name ="healing", interval = 2000, chance = 20, minDamage = 550, maxDamage = 850},
--}
monster.attacks = {
	{ name = "melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -1130 },
