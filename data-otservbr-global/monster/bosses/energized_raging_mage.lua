...
--monster.attacks = {
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -0, range = ?, effect = <>, target = ?}, --+ shaped Energy Field
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ENERGYDAMAGE, minDamage = -100, maxDamage = -200, range = ?, effect = <>, target = ?}, --[[Thunderstorm]]
--	{name ="healing", interval = 2000, chance = 20, minDamage = 150, maxDamage = 200},
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_MANADRAIN, minDamage = -100, maxDamage = -209, range = ?, effect = <>, target = ?}, --Mana Drain
--}
monster.attacks = {
