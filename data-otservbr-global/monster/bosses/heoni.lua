...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -0, range = ?, effect = <>, target = ?}, --Poison Wave
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -makes you [[drunk]], maxDamage = -makes you [[drunk]], range = ?, effect = <>, target = ?}, --Musical Wave
--	{name ="healing", interval = 2000, chance = 20, minDamage = 61, maxDamage = 90},
--}
monster.attacks = {
