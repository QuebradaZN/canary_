...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -2 [[Bolt]]s per turn, maxDamage = -2 [[Bolt]]s per turn, range = ?, effect = <>, target = ?}, --[[Distance Fighting]]
--}
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -170},
