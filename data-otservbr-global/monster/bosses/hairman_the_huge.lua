...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -30, maxDamage = -100, range = ?, effect = <>, target = ?}, --Throws small stones
--	{name ="healing", interval = 2000, chance = 20, minDamage = 25, maxDamage = 50?},
--}
monster.attacks = {
