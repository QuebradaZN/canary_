...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -28, maxDamage = -38, range = ?, effect = <>, target = ?}, --[[Throwing Star]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -3 seconds, maxDamage = -3 seconds, range = ?, effect = <>, target = ?}, --Intoxicate
