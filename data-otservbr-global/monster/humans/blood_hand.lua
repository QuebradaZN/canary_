...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -70+, range = ?, effect = <>, target = ?}, --Frequent [[Self-Healing]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -close range only, maxDamage = -close range only, range = ?, effect = <>, target = ?}, --[[Paralyze]] Ball
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_LIFEDRAIN, minDamage = -20, maxDamage = -60? , range = ?, effect = <>, target = ?}, --[[Life Drain]] Ball on self
--}
monster.attacks = {
