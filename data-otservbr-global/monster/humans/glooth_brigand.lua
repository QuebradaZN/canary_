...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -40, maxDamage = -200?, range = ?, effect = <>, target = ?}, --Shoots [[Arrow]]s
--	{name ="healing", interval = 2000, chance = 20, minDamage = 200, maxDamage = 245+},
--}
monster.attacks = {
