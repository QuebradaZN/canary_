...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -1000+, range = ?, effect = <>, target = ?}, --[[Poison Arrow]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -?, maxDamage = -500+, range = ?, effect = <>, target = ?}, --[[Blood Bomb]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -?, maxDamage = -500+, range = ?, effect = <>, target = ?}, --[[Smoke Bomb]] on itself
--}
monster.attacks = {
