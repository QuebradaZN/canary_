...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ENERGYDAMAGE, minDamage = -400, maxDamage = -600, range = ?, effect = <>, target = ?}, --Energy Beam
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_HOLYDAMAGE, minDamage = -550, maxDamage = -750, range = ?, effect = <>, target = ?}, --Divine Berserk
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ENERGYDAMAGE, minDamage = -600, maxDamage = -820, range = ?, effect = <>, target = ?}, --Energy Hit
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_DEATHDAMAGE, minDamage = -900, maxDamage = -1050, range = ?, effect = <>, target = ?}, --Death Bomb
