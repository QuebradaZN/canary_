...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ENERGYDAMAGE, minDamage = -0, maxDamage = -800+?, range = ?, effect = <>, target = ?}, --[[Great Energy Beam]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ENERGYDAMAGE, minDamage = -0, maxDamage = -200+?, range = ?, effect = <>, target = ?}, --[[Energy Strike]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -200?, range = ?, effect = <>, target = ?}, --[[Wrath of Nature]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -[[Paralyze]]s, maxDamage = -[[Paralyze]]s, range = ?, effect = <>, target = ?}, --
--}
monster.attacks = {
	{name ="melee", interval = 2000, chance = 100, minDamage = 0, maxDamage = -200},
