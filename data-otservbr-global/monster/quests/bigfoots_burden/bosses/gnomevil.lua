...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ICEDAMAGE, minDamage = -400, maxDamage = -750, range = ?, effect = <>, target = ?}, --Ice Strike
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -400, maxDamage = -750, range = ?, effect = <>, target = ?}, --Terra Strike
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_MANADRAIN, minDamage = -350, maxDamage = -750+?, range = ?, effect = <>, target = ?}, --Mana Drain Energy Beam
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_MANADRAIN, minDamage = -0, maxDamage = -0, range = ?, effect = <>, target = ?}, --Mana Drain Icicle
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -electrifies for 36 turns, maxDamage = -electrifies for 36 turns, range = ?, effect = <>, target = ?}, --Electrifying Energy Beam
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -burns for 159 turns, maxDamage = -burns for 159 turns, range = ?, effect = <>, target = ?}, --Burning Fire Wave
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -0, range = ?, effect = <>, target = ?}, --Invisibility
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -1500, range = ?, effect = <>, target = ?}, --Very Frequent [[Self-Healing]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -20000, range = ?, effect = <>, target = ?}, --Frequent [[Self-Healing]]
--}
monster.attacks = {
