...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_FIREDAMAGE, minDamage = -0, maxDamage = -6?, range = ?, effect = <>, target = ?}, --[[Fire Damage|Hearts Beam]]
--	{name ="healing", interval = 2000, chance = 20, minDamage = 0, maxDamage = 199?},
--}
monster.attacks = {
