...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -237+, range = ?, effect = <>, target = ?}, --White Musical Bomb around itself
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -50, maxDamage = -65, range = ?, effect = <>, target = ?}, --slow [[Self-Healing]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -poisons for up to 9 hp/turn, maxDamage = -poisons for up to 9 hp/turn, range = ?, effect = <>, target = ?}, --earth wave
--}
monster.attacks = {
