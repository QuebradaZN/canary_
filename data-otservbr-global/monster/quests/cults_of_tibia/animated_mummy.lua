...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -30, maxDamage = -40, range = ?, effect = <>, target = ?}, --Death Hit
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -Reduces 53, maxDamage = -113 speed levels, range = ?, effect = <>, target = ?}, --Ranged Paralysis
--}
monster.attacks = {
