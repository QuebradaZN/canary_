...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -210, range = ?, effect = <>, target = ?}, --Shoots [[Arrow]]
--	{name ="healing", interval = 2000, chance = 20, minDamage = 400, maxDamage = 480},
--}
monster.attacks = {
