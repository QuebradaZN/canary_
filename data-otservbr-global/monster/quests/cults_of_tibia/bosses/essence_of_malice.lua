...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_DEATHDAMAGE, minDamage = -200, maxDamage = -747, range = ?, effect = <>, target = ?}, --Death Missile
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_DEATHDAMAGE, minDamage = -116, maxDamage = -392, range = ?, effect = <>, target = ?}, --Chain Lightning
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_DEATHDAMAGE, minDamage = -203, maxDamage = -300, range = ?, effect = <>, target = ?}, --Death Beam
--}
monster.attacks = {
