...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -0, maxDamage = -200; causes bleeding starting from up to 35 hp per turn, range = ?, effect = <>, target = ?}, --Earth Explosion on target
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_LIFEDRAIN, minDamage = -650, maxDamage = -800+, range = ?, effect = <>, target = ?}, --Explosion Life Drain Wave
