...
--	{name ="healing", interval = 2000, chance = 20, minDamage = 180, maxDamage = 240?},
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ICEDAMAGE, minDamage = -160, maxDamage = -250?, range = ?, effect = <>, target = ?}, --Ice Wave
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ICEDAMAGE, minDamage = -220, maxDamage = -350?, range = ?, effect = <>, target = ?}, --Ice Beam
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -0, range = ?, effect = <>, target = ?}, --[[Paralysis]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_ICEDAMAGE, minDamage = -200, maxDamage = -300?, range = ?, effect = <>, target = ?}, --Eternal Winter on Target
--}
monster.attacks = {
