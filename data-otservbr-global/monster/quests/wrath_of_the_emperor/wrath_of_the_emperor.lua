...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -900?, range = ?, effect = <>, target = ?}, --Soulfire Beam
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_LIFEDRAIN, minDamage = -0, maxDamage = -800, range = ?, effect = <>, target = ?}, --life drain Energy Wave
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -skill drain?, maxDamage = -skill drain?, range = ?, effect = <>, target = ?}, --Purple Musical Bomb
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_MANADRAIN, minDamage = -0, maxDamage = -360, range = ?, effect = <>, target = ?}, --Big Mana Drain Bomb
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_LIFEDRAIN, minDamage = -200+, maxDamage = -200+, range = ?, effect = <>, target = ?}, --Distance life drain hit
--	{name ="healing", interval = 2000, chance = 20, minDamage = ?, maxDamage = 700},
--}
monster.attacks = {
