...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -up to 40 [[Hitpoints|hp]]/turn, maxDamage = -up to 40 [[Hitpoints|hp]]/turn, range = ?, effect = <>, target = ?}, --[[Poisoned|poison]]s you
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -may [[Paralysis|paralyze]] you, maxDamage = -may [[Paralysis|paralyze]] you, range = ?, effect = <>, target = ?}, --Poison Ball
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -poisons you up to 40 hp/turn, maxDamage = -poisons you up to 40 hp/turn, range = ?, effect = <>, target = ?}, --Poison Ball
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -50, maxDamage = -300, range = ?, effect = <>, target = ?}, --Poison Ball
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -, maxDamage = -, range = ?, effect = <>, target = ?}, --Poison Berserk
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -300, maxDamage = -800+, range = ?, effect = <>, target = ?}, --[[Sudden Death]]
--}
monster.attacks = {
