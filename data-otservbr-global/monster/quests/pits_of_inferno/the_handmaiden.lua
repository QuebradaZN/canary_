...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_LIFEDRAIN, minDamage = -0, maxDamage = -1270+, range = ?, effect = <>, target = ?}, --Life Drain
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_MANADRAIN, minDamage = -0, maxDamage = -861+, range = ?, effect = <>, target = ?}, --Mana Drain
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -makes you [[Drunkenness|drunk]], maxDamage = -makes you [[Drunkenness|drunk]], range = ?, effect = <>, target = ?}, --[[Drunkenness|Drunk Death Bomb]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -0, range = ?, effect = <>, target = ?}, --Infrequent [[Invisibility]]
--}
monster.attacks = {
