...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -707+, range = ?, effect = <>, target = ?}, --[[Distance Fighting]] [[Throwing Knife|Throwing Knives]]
