...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -Poisons up to 50hp/turn, maxDamage = -Poisons up to 50hp/turn, range = ?, effect = <>, target = ?}, --Close Range Poisoned
