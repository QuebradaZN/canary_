...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_EARTHDAMAGE, minDamage = -80, maxDamage = -110, range = ?, effect = <>, target = ?}, --Poison shot
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -[[Poisoned|poisons]] starting at 14 hp, maxDamage = -[[Poisoned|poisons]] starting at 14 hp, range = ?, effect = <>, target = ?}, --[[Terra Wave]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -unknown effect, maxDamage = -unknown effect, range = ?, effect = <>, target = ?}, --Death Explosion on itself
--}
monster.attacks = {
