...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -193+, range = ?, effect = <>, target = ?}, --throws Stone
--	{name ="healing", interval = 2000, chance = 20, minDamage = 0, maxDamage = 119+},
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -0, maxDamage = -0, range = ?, effect = <>, target = ?}, --[[Red Sparkles Effect]]
--}
monster.attacks = {
