...
--monster.attacks = {
--	{name ="melee", interval = 2000, chance = 100, minDamage = -217, maxDamage = -217},
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_DEATHDAMAGE, minDamage = -211, maxDamage = -227, range = ?, effect = <>, target = ?}, --Death Bomb
