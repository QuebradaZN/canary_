...
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_MANADRAIN, minDamage = -430, maxDamage = -550, range = ?, effect = <>, target = ?}, --[[Mana Drain]]
--	{name ="combat", interval = 2000, chance = 20, type = COMBAT_PHYSICALDAMAGE, minDamage = -causes [[Drunkenness]], maxDamage = -causes [[Drunkenness]], range = ?, effect = <>, target = ?}, --[[Great Fireball]]
