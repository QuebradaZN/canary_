...
addTravelKeyword('chor', nil, 30, Position(32968, 32799, 7), false)
addTravelKeyword('banuta', nil, 30, Position(32826, 32631, 7), false)
addTravelKeyword('mountain', nil, 30, Position(32987, 32729, 7), false)
addTravelKeyword('mountain pass', nil, 30, Position(32987, 32729, 7), false)
-- Basic
