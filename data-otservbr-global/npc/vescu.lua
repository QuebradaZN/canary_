...
local config = {
	['15 bonelord eyes'] = { storageValue = 1, text = { 'Have you really managed to bring me 15 bonelord eyes? <hicks>', 'Do bonelord eyes continue blinking when they are seperated from the bonelord? That is a scary thought.', 'Aw-awsome! <hicks> Squishy! Now, please bring me 10 {red dragon scales}.' }, itemId = 5898, count = 15 },
	['bonelord eyes'] = { storageValue = 1, text = { 'Have you really managed to bring me 15 bonelord eyes? <hicks>', 'Do bonelord eyes continue blinking when they are seperated from the bonelord? That is a scary thought.', 'Aw-awsome! <hicks> Squishy! Now, please bring me 10 {red dragon scales}.' }, itemId = 5898, count = 15 },
	['bonelord eye'] = { storageValue = 1, text = { 'Have you really managed to bring me 15 bonelord eyes? <hicks>', 'Do bonelord eyes continue blinking when they are seperated from the bonelord? That is a scary thought.', 'Aw-awsome! <hicks> Squishy! Now, please bring me 10 {red dragon scales}.' }, itemId = 5898, count = 15 },
	['5 red dragon scales'] = { storageValue = 2, text = { 'D-did you get all of the 5 red dragon scales? <hicks>', 'Have you ever wondered if a red dragon means \'stop\' whereas a green dragon means \'go\'?', 'G-good work, ... wha-what\'s your name again? <hicks> Anyway... come back with 30 {lizard scales}.' }, itemId = 5882, count = 5 },
	['red dragon scales'] = { storageValue = 2, text = { 'D-did you get all of the 5 red dragon scales? <hicks>', 'Have you ever wondered if a red dragon means \'stop\' whereas a green dragon means \'go\'?', 'G-good work, ... wha-what\'s your name again? <hicks> Anyway... come back with 30 {lizard scales}.' }, itemId = 5882, count = 5 },
	['red dragon scale'] = { storageValue = 2, text = { 'D-did you get all of the 5 red dragon scales? <hicks>', 'Have you ever wondered if a red dragon means \'stop\' whereas a green dragon means \'go\'?', 'G-good work, ... wha-what\'s your name again? <hicks> Anyway... come back with 30 {lizard scales}.' }, itemId = 5882, count = 5 },
