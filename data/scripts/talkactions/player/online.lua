<<<<<<< HEAD:data-canary/scripts/talkactions/player/online.lua
...
||||||| 83d2da85a:data/scripts/talkactions/player/online.lua
=======
local maxPlayersPerMessage = 10
local playersOnline = TalkAction("!online")
...
playersOnline:register()
>>>>>>> upstream/main:data/scripts/talkactions/player/online.lua
