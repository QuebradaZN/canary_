...
local houseDecorations = {
	...
	{
		icons = { "Rolled-up_Lilac_Carpet.png" },
		name = "Lilac Carpet",
		price = 5,
		itemtype = 35887,
		count = 1,
	...
	{
		icons = { "Opulent_Wood_Floor.png" },
		name = "Opulent Wood Floor",
		price = 5,
		itemtype = 42336,
		count = 1,
		description = "{house}\n{box}\n{storeinbox}\n{use}\n{backtoinbox}",
	...
	},
	{
		...
		name = "Painting of Tibiasula (Tibiasula)",
		price = 5,
		itemtype = 28947,
		count = 1,
		description = "{house}\n{box}\n{storeinbox}\n{use}\n{backtoinbox}",
	...
	{
		icons = { "Painting_of_Tibiasula.png" },
		name = "Painting of Tibiasula (Zathroth)",
		price = 5,
		itemtype = 28948,
		count = 1,
		description = "{house}\n{box}\n{storeinbox}\n{use}\n{backtoinbox}",
...
for i = 1, #houseDecorations do
	local copy = table.copy(houseDecorations[i])
	copy.count = copy.count * 5
	copy.price = copy.price * 5
	table.insert(houseDecorations, copy)
end
...
GameStore.Categories = {
	...
	-- Consumables ~ Concoctions
	{
		...
		state = GameStore.States.STATE_NONE,
		offers = {
			{ name = "Stamina Extension", price = 50, itemtype = Concoction.Ids.StaminaExtension, count = 1, description = "<i>Gives you + one hour of stamina upon usage.</i>\n\n{info}you can only use one every 30 minutes.\n{character}\n{storeinbox}\n{battlesign}\n{capacity}", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE },
			{ name = "Kooldown Aid", price = 50, itemtype = Concoction.Ids.KooldownAid, count = 1, description = "<i>Clears all of your spell cooldowns.</i>\n\n{info}you can only use one every 10 hours.\n{character}\n{storeinbox}\n{battlesign}\n{capacity}", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE },
		...
		offers = {
			{
				...
				price = 150,
				id = 44,
				description = "{character}\n{speedboost}\n\n<i>With its ancient scales and primal strength, this fearsome mount will carry you through the ages, evoking the thrill of riding alongside a true dinosaur companion. Are you ready to awaken the spirit of ancient adventure?</i>",
			...
			},
			{
				...
				price = 150,
				id = 145,
				description = "{character}\n{speedboost}\n\n<i>Unleash the spirit of a valiant knight with the Jousting Eagle. Soar high above the realms, and partake in daring aerial jousts, as you forge an unbreakable bond with this noble and majestic winged companion.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_MOUNT,
			},
			{
	...
	-- Cosmetics ~ Outfits (base outfit has addon = 0 or no defined addon. By default addon is set to 0)
	{
		...
		offers = {
			...
			},
			{
				...
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>on this legendary garb, adorned with the trophies of vanquished dragons, and embark on epic quests as a formidable hero, feared by dragons and revered by adventurers.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
			...
			},
			{
				...
				addon = 3,
				description = "{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i> Imbued with the essence of nature, this majestic attire exudes the spirit of a seasoned adventurer, ready to explore the untamed beauty of the land and embark on daring quests.</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
			...
			},
			{
				...
				addon = 3,
				description =
				"{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>Roar into battle with the Lion of War outfit! Fearless and bold, this legendary attire embodies the spirit of a valiant warrior, ready to conquer any challenge on the battlefield. Embrace the strength of the lion and become a true champion of valor!</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
			...
			},
			{
				...
				addon = 3,
				description =
				"{character}\n{info} colours can be changed using the Outfit dialog\n{info} includes basic outfit and 2 addons which can be selected individually\n\n<i>Battle-tested and indomitable, this attire embodies the resilience of a seasoned paladin, standing firm in the face of darkness and defending the innocent with unwavering courage. Take up your sacred arms and shine as a beacon of hope!</i>",
				type = GameStore.OfferTypes.OFFER_TYPE_OUTFIT,
			},
			{
	...
	},
	{
		...
		state = GameStore.States.STATE_NONE,
		offers = {
			{ name = "Stamina Extension", price = 500, itemtype = Concoction.Ids.StaminaExtension, count = 1, description = "<i>Gives you + one hour of stamina upon usage.</i>\n\n{info}you can only use one every 30 minutes.\n{character}\n{storeinbox}\n{battlesign}\n{capacity}", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, coinType = GameStore.CoinType.Online },
			{ name = "Kooldown Aid", price = 500, itemtype = Concoction.Ids.KooldownAid, count = 1, description = "<i>Clears all of your spell cooldowns.</i>\n\n{info}you can only use one every 10 hours.\n{character}\n{storeinbox}\n{battlesign}\n{capacity}", type = GameStore.OfferTypes.OFFER_TYPE_STACKABLE, coinType = GameStore.CoinType.Online },
