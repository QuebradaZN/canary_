...
stairJumpExhaustion = 2000 -- miliseconds
...
maxPlayers = 0
serverName = "Elysiera"
serverMotd = "Welcome to Elysiera!\nFor server info, please check our website at www.elysiera.com.\nMake sure to join the server's discord at https://discord.gg/rrzKAgXuzq for questions, suggestions, bug reports and to make sure you are on top with new content being added."
