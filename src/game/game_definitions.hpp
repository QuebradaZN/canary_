...
enum HighscoreCategories_t : uint8_t {
	...
	HIGHSCORE_CATEGORY_LUCK,
	HIGHSCORE_CATEGORY_MELEE_FIGHTING,
	HIGHSCORE_CATEGORY_DEXTERITY,
	HIGHSCORE_CATEGORY_RUNIC_FIGHTING,
	HIGHSCORE_CATEGORY_DISTANCE_FIGHTING,
	HIGHSCORE_CATEGORY_DEFENSE,
	HIGHSCORE_CATEGORY_TONICITY,
